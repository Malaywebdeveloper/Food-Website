    ...
    <Layout>
      ...
      >
        ...
        <p>
          ...
          obcaecati qui necessitatibus magni non odit tempore amet. Excepturi at
          ad similique magnam repudiandae fuga cupiditate voluptatem adipisci
          sapiente ex blanditiis enim quibusdam minima sequi facilis iste,
          perferendis nostrum earum illo sed corrupti! Sapiente adipisci eveniet
          corporis voluptates, minima dolores consequatur, distinctio optio
          similique doloribus, libero beatae possimus maiores necessitatibus.
          Corporis distinctio minima sequi fuga? Adipisci inventore nemo cum
          eaque obcaecati dolorum, unde assumenda debitis natus?
        </p>
        <br />
        <p>
          ...
          corrupti excepturi. Corrupti et architecto optio quisquam laudantium,
          magni quia officia mollitia nisi sunt ipsam suscipit est temporibus
          iste cupiditate eum culpa illo eos quibusdam reiciendis.
        </p>
      </Box>
    </Layout>
  );
